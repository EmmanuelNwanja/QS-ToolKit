          ...
          {beams.map((b, i) => (
            <div key={i} className="bg-gray-50 rounded-lg p-3 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div><label className={lbl}>Width (mm)</label><input type="number" className={inputCls} value={b.width_mm} onChange={e => updateItem(setBeams, i, 'width_mm', e.target.value)} /></div>
                <div><label className={lbl}>Depth (mm)</label><input type="number" className={inputCls} value={b.depth_mm} onChange={e => updateItem(setBeams, i, 'depth_mm', e.target.value)} /></div>
        ...
        <div className="space-y-2">
          ...
          {columns.map((c, i) => (
            <div key={i} className="bg-gray-50 rounded-lg p-3 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div><label className={lbl}>Width (mm)</label><input type="number" className={inputCls} value={c.width_mm} onChange={e => updateItem(setColumns, i, 'width_mm', e.target.value)} /></div>
                <div><label className={lbl}>Depth (mm)</label><input type="number" className={inputCls} value={c.depth_mm} onChange={e => updateItem(setColumns, i, 'depth_mm', e.target.value)} /></div>
          ...
          {lintels.map((l, i) => (
            <div key={i} className="bg-gray-50 rounded-lg p-3 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div><label className={lbl}>Width (mm)</label><input type="number" className={inputCls} value={l.width_mm} onChange={e => updateItem(setLintels, i, 'width_mm', e.target.value)} /></div>
                <div><label className={lbl}>Depth (mm)</label><input type="number" className={inputCls} value={l.depth_mm} onChange={e => updateItem(setLintels, i, 'depth_mm', e.target.value)} /></div>
        ...
        <div className="space-y-3">
          ...
          {stairEnabled && (
            <div className="bg-gray-50 rounded-lg p-3 grid grid-cols-2 gap-2">
              <div><label className={lbl}>Waist Length (m)</label><input type="number" step="0.01" className={inputCls} value={stair.waist_length_m} onChange={e => setStair(s => ({ ...s, waist_length_m: e.target.value }))} /></div>

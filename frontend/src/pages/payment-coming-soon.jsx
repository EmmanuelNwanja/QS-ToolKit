    ...
    <ProtectedRoute>
      ...
      <Layout title="Online Payments">
        <div className="max-w-lg mx-auto py-16 px-4 text-center">
          ...
          <h1 className="font-display font-bold text-2xl text-slate-800 mb-3">Online Payments Unavailable</h1>
          <p className="text-slate-500 text-sm leading-relaxed mb-8">
            This online payment method is not yet available on QSToolkit.
          ...
          <p className="text-xs text-slate-400 mt-8">
            ...
            <a href="mailto:dev@qs.solnuv.com" className="text-primary-700 hover:underline">
              dev@qs.solnuv.com
            </a>
          </p>
        </div>

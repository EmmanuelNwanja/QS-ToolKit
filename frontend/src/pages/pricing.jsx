  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white font-sans w-full max-w-[100vw]">
        {/* Navbar */}
        <nav className="fixed top-0 left-0 right-0 z-50 bg-primary-900 border-b border-white/10">
          <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2 group">
              <img src="/qs-toolkit-logo-2.png" alt="QSToolkit" className="h-14 sm:h-16 w-auto max-w-[200px] sm:max-w-[220px]" />
            </Link>

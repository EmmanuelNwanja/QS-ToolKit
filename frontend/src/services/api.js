...
export const academyAPI = {
  ...
  submitBankTransfer: (data)                  => api.post('/academy/subscribe', { ...data, payment_method: 'bank_transfer' }),
  getBankTransferSettings: ()                 => api.get('/academy/bank-transfer-settings'),
...
export const examAPI = {
  ...
  submitBankTransfer: (data)                  => api.post('/exam-prep/subscribe', { ...data, payment_method: 'bank_transfer' }),
  getBankTransferSettings: ()                 => api.get('/exam-prep/bank-transfer-settings'),
